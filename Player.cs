    ...
    private void OnTriggerEnter2D(Collider2D whatIHit)
    {
        if(whatIHit.tag == "Powerup")
        {
            ...
            switch(powerupType)
            {
                case 1:
                    //speed powerup
                    speed = 9f; // This activates the speed powerup
                ...
                case 4:
                    ...
                    hasShield = true; // This activates the shield
                    shield.gameObject.SetActive(true); // This will make the shield appear
                    StartCoroutine(ShieldPowerDown());
                    break;
            }
            Destroy(whatIHit.gameObject); // Destroy the powerup object after pickup
        }
    }
}
